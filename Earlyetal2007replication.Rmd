...
# add Bachelors
jags.dat$Bachelors <- ifelse(jags.dat$BA==1, 1, ifelse(jags.dat$Grad==1, 1, ifelse(jags.dat$BA==0, 0, ifelse(jags.dat$Grad==0, 0, NA)))) # reference group is no bachelors
...
jags.dat$param.Bachelors <- mean(jags.dat$Bachelors, na.rm=TRUE)
...
for(i in 1:4){
  ...
  betas <- subset(fit.gg, Parameter=="b.0" | Parameter=="b.0class" | Parameter=="b.AS" | Parameter=="b.BA" | Parameter=="b.Grad")
  ...
  betas <- subset(fit.gg, Parameter=="b.Bachelors" | Parameter=="b.0" | Parameter=="b.0class" )
